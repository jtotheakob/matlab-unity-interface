...
%deflection ranges between 0.04m to 0.09m. The output LCLFORCE and 
%MCLFORCE is calculated by applying hooke's law with the spring constant 
%of 1(N/m) and a deflection change that is calculated relative to the 
%medium value; i.e., 0.05m and 0.55m.
