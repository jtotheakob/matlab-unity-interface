...
public class TargetPosition : MonoBehaviour
{
    ...
    *
    *The TargetPosition class is retrieving the position and the rotation from the respective GameObjects 
    *and storing them to separate variables. GamePose1 represents the femur and GamePose2 the tibia.
    *Additionally the live data, i.e., the rotation quaternion and the position vector of the femur, is 
    *printed on to the video stream of the ARCamera with the help of a description field. The field and the 
